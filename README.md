...
**IT環境ゼロの製造現場で、社内システム基盤を構築**

#### 1. **社内システム基盤の構築**
- 社内LAN環境の整備・運用設計
- NASサーバー構築によるセキュアなデプロイ環境確立
- WiFi環境整備（産業機器の安定接続を実現）
- 社内PC・エンドユーザーの管理体制確立

#### 2. **IoT導入とデータ収集基盤**
- **複数の産業機器へのIoT導入**（ダイカストマシン）
...
#### プロジェクト1：大手企業向け統合API基盤構築
- AWS環境でのセキュアなAPI基盤構築
- 認証認可システムの実装（AWS Cognito, Verified Permissions）
- API統合基盤の設計・開発
...
**使用技術：** Vue.js2, Python, FastAPI, MySQL, DynamoDB, AWS, Jenkins
